                    ...
                    <div className="footer-grid">
                        ...
                        <div className="footer-col">
                            ...
                            <div className="footer-socials">
                                ...
                                {/* Instagram */}
                                <a href="#" className="footer-social-icon" style={{ width: '36px', height: '36px', minWidth: '36px', backgroundColor: '#1F2937', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none' }}>
                                    <svg fill="#ffffff" viewBox="0 0 24 24" style={{ width: '16px', height: '16px', display: 'block', flexShrink: 0 }}>
